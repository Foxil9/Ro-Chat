...
contextBridge.exposeInMainWorld("electronAPI", {
  ...
  onAutoHideHeaderChanged: (callback) => {
    ...
    return () =>
      ipcRenderer.removeListener("settings:autoHideHeaderChanged", listener);
  },
  ...
  onAutoHideFooterChanged: (callback) => {
    ...
    return () =>
      ipcRenderer.removeListener("settings:autoHideFooterChanged", listener);
  },
  ...
  onMessageEditError: (callback) => {
    ...
    return () =>
      ipcRenderer.removeListener("socket:messageEditError", listener);
  },
  ...
  onMessageDeleteError: (callback) => {
    ...
    return () =>
      ipcRenderer.removeListener("socket:messageDeleteError", listener);
  },
  ...
  settings: {
    ...
    registerKeybind: (keybind) =>
      ipcRenderer.invoke("settings:registerKeybind", keybind),
    setMessageOpacity: (opacity) =>
      ipcRenderer.send("settings:setMessageOpacity", opacity),
    setAutoHideHeader: (enabled) =>
      ipcRenderer.invoke("settings:setAutoHideHeader", enabled),
    setAutoHideFooter: (enabled) =>
      ipcRenderer.invoke("settings:setAutoHideFooter", enabled), // CSS FIX: IPC for footer visibility
  },
